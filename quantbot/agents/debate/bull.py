"""Bull Advocate — argues the LONG case in structured debate."""
...
def invoke_bull_advocate(
    instrument: str,
    signals: list[Signal],
    bars_summary: str,
) -> dict[str, Any]:
    """Run the bull advocate and return structured arguments.
    ...
    """
    system_prompt = load_prompt("bull_advocate")
...
Argue the strongest possible LONG case for {instrument}.
"""
    ...
    try:
        ...
        return {
            "thesis": "Unable to parse bull argument",
            "supporting_evidence": [],
            "conviction": 0.0,
